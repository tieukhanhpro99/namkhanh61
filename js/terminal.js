...
const base = `namkhanh@<span style="color: #b8d5ef">namkhanh61.net</span>:<span style="color: dodgerblue">~</span>$ `;
let array = [];
let input = "";
let lastIdx = -1;
let lastCmd = "";
...
document.addEventListener("keydown", function(a) {
    ...
    case "Enter":
        ...
        if (d) {
            ...
            default:
                d = false;
                writeLine(`msh: command not found: ${f}`);
                break
            }
        }
        switchToNewLine(d);
...
function print404() {
    ...
    writeLine(`msh: <span>404</span> - Page not found. Redirected to the main page in <span>24h</span>.......`);
    inputLine("./main");
    switchToNewLine()
}
function inputLine(k) {
    terminal.innerHTML += `\n<div class=\"new-line\">namkhanh@<span style=\"color: #b8d5ef\">namkhanh61.net</span>:<span style=\"color: dodgerblue\">~</span>$ ${k ? k : ""}</div>`
}
...
function info() {
    terminal.innerHTML += '\n<img alt="icon" class="img" src="static/icon.png">\n' + "  <div><span>namkhanh</span>@<span>namkhanh61.net</span></div>\n" + "  <div>---------------------</div>\n" + "  <div><span>OS</span>: windozen</div>\n" + "  <div><span>Ages</span>: 13</div>\n" + "  <div><span>Facebook</span>: <a href=\"facebook.com\namkhanh61\" target='_blank'>Nam Khánh</a></div>\n" + "  <div><span>Discord</span>: <a href=\"https://discord.com\" target='_blank'>NamKhanh#7505</a></div>\n" + "  <div><span>Youtube</span>: <a href=\"https://www.youtube.com/channel/UCtImmWWwwjaEfVQCLH6J09A\" target='_blank'>Nam Khánh</a></div>\n" + "  <div><span>Github</span>: <a href=\"https://github.com/tieukhanhpro99\" target='_blank'>tieukhanhpro99</a></div>\n" + "  <div><span>osu!</span>: <a href=\"https://osu.ppy.sh/users/18018769\" target='_blank'>- NamKhanh -</a></div>\n" + "  <div><span>Netflix</span>: <a href=\"https://www.facebook.com/namkhanh61\" target='_blank'>Shop now!</a></div>\n" + '  <div style="padding-bottom:10px; clear: both;">'
}
